...
def shortest_path(source, target):
    ...
    # Only Breadth-First Search will return the shortest path
    ...
    while True:
        ...
        for neighbor in neighbors_for_person(node.state):
            ...
            # "neighbor[0]" = movie_id | "neighbor[1]" = person_id

            # If the person is not already in the frontier and in the explored state
            if not frontier.contains_state(neighbor[1]) and neighbor[1] not in explored:
                # Create a nod for every neighbor
